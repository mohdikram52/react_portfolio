    ...
    return (
        <footer className="bg-black text-white border-y ">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="2xl:md:flex 2xl:justify-between md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li>
                                    <Link to="/projects" className="hover:underline hover:text-orange-700">
                                        Projects
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm  text-white uppercase">Legal</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <Link to="#" className="hover:underline hover:text-orange-700">
                                        Privacy Policy
